...
out_dir = experiment_dir.joinpath('connectomes/burgess+gordon')
out_dir.mkdir(exist_ok=True)

parcellation = '/rcc/stor1/depts/neurology/users/jheffernan/hcp/parcellations/Parcels/customize/gordon+subcortical.dlabel.nii'
